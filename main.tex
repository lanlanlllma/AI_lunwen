...
\begin{figure}[htbp]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \path[line] (mcp.south) -- node[midway, left, font=\scriptsize] {底层API调用} (robot.north);
  ...
  -- (feedback.east);      % 向左连接到 feedback.east
        ...
        \path[line, orange!80!black] (feedback.west) -- ++(-7.25,0) -- (operator.south) node[pos=0.25, right, font=\scriptsize, black] {闭环反馈};
